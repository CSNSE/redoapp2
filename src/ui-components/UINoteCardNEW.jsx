...
export default function UINoteCardNEW(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "UINoteCardNEW")}
      {...rest}
    >
      <Image
        width="unset"
            ...
            >
              ...
              >
                <MyIcon
                  ...
                  padding="0px 0px 0px 0px"
                  type="edit"
                  {...getOverrideProps(overrides, "MyIcon4025608")}
                ></MyIcon>
              </View>
              <View
                width="24px"
              ...
              >
                <MyIcon
                  ...
                  padding="0px 0px 0px 0px"
                  type="delete"
                  {...getOverrideProps(overrides, "MyIcon4025607")}
                ></MyIcon>
              </View>
            </Flex>
          </Flex>
